...
ModelCheckIn welcomeFromJson(String str) =>
    ModelCheckIn.fromJson(json.decode(str));

String welcomeToJson(ModelCheckIn data) => json.encode(data.toJson());

class ModelCheckIn {
  final String? message;
  final Data? data;

  ModelCheckIn({this.message, this.data});

  factory ModelCheckIn.fromJson(Map<String, dynamic> json) => ModelCheckIn(
